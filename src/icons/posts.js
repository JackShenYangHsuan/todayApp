...
import cookie from 'react-cookie';
// Develop server URL
const postBaseUrl = 'http://localhost:8089/api';
...
export function sentVideoGenres(genres, user_id = cookie.load('id')){
...
export function getVideoGenres(user_id = cookie.load('id')){
